...
/// <summary>Represents the CreateTemplateVersionResponseDataLocalizationsItem payload.</summary>
public class CreateTemplateVersionResponseDataLocalizationsItem
{
