...
/// <summary>Represents the GetCampaignResponseData payload.</summary>
public class GetCampaignResponseData
{
    ...
    public IReadOnlyList<GetCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
    ...
    public GetCampaignResponseDataStats? Stats { get; set; }
