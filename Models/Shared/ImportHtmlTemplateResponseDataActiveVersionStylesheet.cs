...
/// <summary>Represents the ImportHtmlTemplateResponseDataActiveVersionStylesheet payload.</summary>
public class ImportHtmlTemplateResponseDataActiveVersionStylesheet
{
