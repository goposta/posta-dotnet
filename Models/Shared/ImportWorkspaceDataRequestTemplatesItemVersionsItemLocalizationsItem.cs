...
/// <summary>Represents the ImportWorkspaceDataRequestTemplatesItemVersionsItemLocalizationsItem payload.</summary>
public class ImportWorkspaceDataRequestTemplatesItemVersionsItemLocalizationsItem
{
