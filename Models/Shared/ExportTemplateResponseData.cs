...
/// <summary>Represents the ExportTemplateResponseData payload.</summary>
public class ExportTemplateResponseData
{
    ...
    public IReadOnlyList<ExportTemplateResponseDataVersionsItem>? Versions { get; set; }
