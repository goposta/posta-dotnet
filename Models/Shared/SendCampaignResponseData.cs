...
/// <summary>Represents the SendCampaignResponseData payload.</summary>
public class SendCampaignResponseData
{
    ...
    public IReadOnlyList<SendCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
