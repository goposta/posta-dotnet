...
/// <summary>Represents the ActivateTemplateVersionResponseDataActiveVersion payload.</summary>
public class ActivateTemplateVersionResponseDataActiveVersion
{
    ...
    public IReadOnlyList<ActivateTemplateVersionResponseDataActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public ActivateTemplateVersionResponseDataActiveVersionStylesheet? Stylesheet { get; set; }
