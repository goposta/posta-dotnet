...
/// <summary>Represents the ImportTemplateRequestVersionsItemLocalizationsItem payload.</summary>
public class ImportTemplateRequestVersionsItemLocalizationsItem
{
