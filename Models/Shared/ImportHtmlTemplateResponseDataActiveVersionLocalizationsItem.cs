...
/// <summary>Represents the ImportHtmlTemplateResponseDataActiveVersionLocalizationsItem payload.</summary>
public class ImportHtmlTemplateResponseDataActiveVersionLocalizationsItem
{
