...
/// <summary>Represents the AddDomainResponseData payload.</summary>
public class AddDomainResponseData
{
    ...
    public AddDomainResponseDataDnsRecords? DnsRecords { get; set; }
