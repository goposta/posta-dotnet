...
/// <summary>Represents the ImportTemplateResponseDataActiveVersion payload.</summary>
public class ImportTemplateResponseDataActiveVersion
{
    ...
    public IReadOnlyList<ImportTemplateResponseDataActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public ImportTemplateResponseDataActiveVersionStylesheet? Stylesheet { get; set; }
