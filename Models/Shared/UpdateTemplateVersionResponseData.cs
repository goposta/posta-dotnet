...
/// <summary>Represents the UpdateTemplateVersionResponseData payload.</summary>
public class UpdateTemplateVersionResponseData
{
    ...
    public IReadOnlyList<UpdateTemplateVersionResponseDataLocalizationsItem>? Localizations { get; set; }
    ...
    public UpdateTemplateVersionResponseDataStylesheet? Stylesheet { get; set; }
