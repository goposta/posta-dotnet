...
/// <summary>Represents the UpdateCampaignResponseData payload.</summary>
public class UpdateCampaignResponseData
{
    ...
    public IReadOnlyList<UpdateCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
