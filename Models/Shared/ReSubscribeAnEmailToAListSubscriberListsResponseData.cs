...
/// <summary>Represents the ReSubscribeAnEmailToAListSubscriberListsResponseData payload.</summary>
public class ReSubscribeAnEmailToAListSubscriberListsResponseData
{
