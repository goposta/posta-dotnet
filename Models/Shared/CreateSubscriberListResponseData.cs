...
/// <summary>Represents the CreateSubscriberListResponseData payload.</summary>
public class CreateSubscriberListResponseData
{
    ...
    public IReadOnlyList<CreateSubscriberListResponseDataFilterRulesItem>? FilterRules { get; set; }
