...
/// <summary>Represents the DuplicateCampaignResponseData payload.</summary>
public class DuplicateCampaignResponseData
{
    ...
    public IReadOnlyList<DuplicateCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
