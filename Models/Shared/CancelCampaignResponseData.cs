...
/// <summary>Represents the CancelCampaignResponseData payload.</summary>
public class CancelCampaignResponseData
{
    ...
    public IReadOnlyList<CancelCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
