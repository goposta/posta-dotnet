...
/// <summary>Represents the ImportHtmlTemplateResponseDataActiveVersion payload.</summary>
public class ImportHtmlTemplateResponseDataActiveVersion
{
    ...
    public IReadOnlyList<ImportHtmlTemplateResponseDataActiveVersionLocalizationsItem>? Localizations { get; set; }
    ...
    public ImportHtmlTemplateResponseDataActiveVersionStylesheet? Stylesheet { get; set; }
