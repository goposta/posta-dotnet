...
/// <summary>Represents the GetSubscriberListResponseData payload.</summary>
public class GetSubscriberListResponseData
{
    ...
    public IReadOnlyList<GetSubscriberListResponseDataFilterRulesItem>? FilterRules { get; set; }
