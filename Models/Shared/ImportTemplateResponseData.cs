...
/// <summary>Represents the ImportTemplateResponseData payload.</summary>
public class ImportTemplateResponseData
{
    /// <summary>Gets or sets <c>active_version</c>.</summary>
    [JsonPropertyName("active_version")]
    public ImportTemplateResponseDataActiveVersion? ActiveVersion { get; set; }
    ...
    public ImportTemplateResponseDataCreatedBy? CreatedBy { get; set; }
    ...
    public ImportTemplateResponseDataLastEditedBy? LastEditedBy { get; set; }
