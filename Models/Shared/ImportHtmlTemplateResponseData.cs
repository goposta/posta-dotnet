...
/// <summary>Represents the ImportHtmlTemplateResponseData payload.</summary>
public class ImportHtmlTemplateResponseData
{
    /// <summary>Gets or sets <c>active_version</c>.</summary>
    [JsonPropertyName("active_version")]
    public ImportHtmlTemplateResponseDataActiveVersion? ActiveVersion { get; set; }
    ...
    public ImportHtmlTemplateResponseDataCreatedBy? CreatedBy { get; set; }
    ...
    public ImportHtmlTemplateResponseDataLastEditedBy? LastEditedBy { get; set; }
