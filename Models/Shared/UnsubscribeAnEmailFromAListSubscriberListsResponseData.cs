...
/// <summary>Represents the UnsubscribeAnEmailFromAListSubscriberListsResponseData payload.</summary>
public class UnsubscribeAnEmailFromAListSubscriberListsResponseData
{
