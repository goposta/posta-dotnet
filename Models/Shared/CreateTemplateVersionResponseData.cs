...
/// <summary>Represents the CreateTemplateVersionResponseData payload.</summary>
public class CreateTemplateVersionResponseData
{
    ...
    public IReadOnlyList<CreateTemplateVersionResponseDataLocalizationsItem>? Localizations { get; set; }
    ...
    public CreateTemplateVersionResponseDataStylesheet? Stylesheet { get; set; }
