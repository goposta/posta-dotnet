...
/// <summary>Represents the CreateCampaignResponseData payload.</summary>
public class CreateCampaignResponseData
{
    ...
    public IReadOnlyList<CreateCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
