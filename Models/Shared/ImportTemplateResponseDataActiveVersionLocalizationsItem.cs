...
/// <summary>Represents the ImportTemplateResponseDataActiveVersionLocalizationsItem payload.</summary>
public class ImportTemplateResponseDataActiveVersionLocalizationsItem
{
