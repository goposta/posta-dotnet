...
/// <summary>Represents the ResumeCampaignResponseData payload.</summary>
public class ResumeCampaignResponseData
{
    ...
    public IReadOnlyList<ResumeCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
