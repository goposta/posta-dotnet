...
/// <summary>Represents the ActivateTemplateVersionResponseDataActiveVersionStylesheet payload.</summary>
public class ActivateTemplateVersionResponseDataActiveVersionStylesheet
{
