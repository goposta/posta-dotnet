...
/// <summary>Represents the PauseCampaignResponseData payload.</summary>
public class PauseCampaignResponseData
{
    ...
    public IReadOnlyList<PauseCampaignResponseDataAbTestVariantsItem>? AbTestVariants { get; set; }
