...
/// <summary>Represents the ActivateTemplateVersionResponseDataActiveVersionLocalizationsItem payload.</summary>
public class ActivateTemplateVersionResponseDataActiveVersionLocalizationsItem
{
