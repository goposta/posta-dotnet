...
/// <summary>Represents the ListTemplateVersionsResponseDataItemLocalizationsItem payload.</summary>
public class ListTemplateVersionsResponseDataItemLocalizationsItem
{
