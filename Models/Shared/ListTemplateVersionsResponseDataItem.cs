...
/// <summary>Represents the ListTemplateVersionsResponseDataItem payload.</summary>
public class ListTemplateVersionsResponseDataItem
{
    ...
    public IReadOnlyList<ListTemplateVersionsResponseDataItemLocalizationsItem>? Localizations { get; set; }
    ...
    public ListTemplateVersionsResponseDataItemStylesheet? Stylesheet { get; set; }
