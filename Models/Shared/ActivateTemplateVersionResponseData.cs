...
/// <summary>Represents the ActivateTemplateVersionResponseData payload.</summary>
public class ActivateTemplateVersionResponseData
{
    /// <summary>Gets or sets <c>active_version</c>.</summary>
    [JsonPropertyName("active_version")]
    public ActivateTemplateVersionResponseDataActiveVersion? ActiveVersion { get; set; }
    ...
    public ActivateTemplateVersionResponseDataCreatedBy? CreatedBy { get; set; }
    ...
    public ActivateTemplateVersionResponseDataLastEditedBy? LastEditedBy { get; set; }
