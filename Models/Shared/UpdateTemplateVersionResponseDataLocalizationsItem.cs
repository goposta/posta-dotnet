...
/// <summary>Represents the UpdateTemplateVersionResponseDataLocalizationsItem payload.</summary>
public class UpdateTemplateVersionResponseDataLocalizationsItem
{
