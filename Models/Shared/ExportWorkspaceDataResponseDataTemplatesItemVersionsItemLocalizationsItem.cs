...
/// <summary>Represents the ExportWorkspaceDataResponseDataTemplatesItemVersionsItemLocalizationsItem payload.</summary>
public class ExportWorkspaceDataResponseDataTemplatesItemVersionsItemLocalizationsItem
{
