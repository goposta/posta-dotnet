...
/// <summary>Represents the ImportTemplateResponseDataActiveVersionStylesheet payload.</summary>
public class ImportTemplateResponseDataActiveVersionStylesheet
{
