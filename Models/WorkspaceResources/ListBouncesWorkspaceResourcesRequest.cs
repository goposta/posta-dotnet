...
/// <summary>Represents the ListBouncesWorkspaceResourcesRequest payload.</summary>
public class ListBouncesWorkspaceResourcesRequest : Shared.SearchableListRequest
{
